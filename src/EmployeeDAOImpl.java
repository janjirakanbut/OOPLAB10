...
public class EmployeeDAOImpl implements employeeDAO {
    ...
    public void updateEmp(Employee employee) {
        try {
            ...
            if (rs != 0){
                System.out.println("Data with empID"+employee.getEmpID()+"was updated.");
            }else {
                System.out.println("Cloud not update data with empID"+employee.getEmpID());
            }
            ps.close();
            conn.close();
    ...
    public Employee findEmp(int id) {
        ...
        try {
            ...
            if (rs.next()){
                ...
                System.out.println("Cloud not found Employee"+"white empID"+id);
            }
            rs.close();
            ps.close();
            conn.close();
